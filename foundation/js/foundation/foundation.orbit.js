;(function ($, window, document, undefined) {
  ...
  var Orbit = function(el, settings) {
    ...
    self.build_markup = function() {
      slides_container.wrap('<div class="'+settings.container_class+' rounded"></div>');
      container = slides_container.parent();
	  container.prepend("<div class='orbit-controls'></div>");
      slides_container.addClass(settings.slides_container_class);
      
      if (settings.navigation_arrows) {
		$(".orbit-controls", container).append($('<a>').addClass(settings.next_class).append('<span>'));
        $(".orbit-controls", container).append($('<a>').addClass(settings.prev_class).append('<span>'));
      ...
      if (settings.bullets) {
        ...
        $(".orbit-controls", container).append(bullets_container);
