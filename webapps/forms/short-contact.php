...
if(isset($_POST['key'])){
	...
	$postArr = array("FullName", "Email", "Availability", "Home1", "Home2", "Home3", "Work1", "Work2", "Work3", "Cell1", "Cell2", "Cell3", "ref");
	...
	$subject = "Short Contact Form Analysis Request (premierconsumer) from ".$form['Name'];
