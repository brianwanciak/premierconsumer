                ...
                <div id="collapseZero" class="accordion-body collapse in">
                  <div class="accordion-inner english">
                           ...
                           <table class="table table-bordered pc-table editor-content">
                                ...
                                <tr>
                                    <td>Youtube Link</td>
                                    <td><input type="text" name="youTubeLink" value="<?php echo $en->youTubeLink; ?>" /></td>
                                </tr>
                                <tr>
                                    <td>Youtube Link (Spanish)</td>
                                    <td><input type="text" name="es-youTubeLink" value="<?php echo $es->youTubeLink; ?>" /></td>
                                </tr>
...
<input type="hidden" name="es-template" value="video" />
