            ...
            <div id="collapseOne" class="accordion-body collapse in">
              <div class="accordion-inner english">
                       ...
                       <table class="table table-bordered pc-table editor-content">
                        ...
                        <h4>Form Embed Code</h4>
                        <table class="table table-bordered pc-table editor-content">
                        	<tr>
                                <td><textarea name="formCode" rows="10"><?php echo $en->formCode; ?></textarea></td>
                            </tr>
                        </table>
            ...
            <div id="collapseTwo" class="accordion-body collapse">
              <div class="accordion-inner es">
                       ...
                       <table class="table table-bordered pc-table editor-content">
                        ...
                        <table class="table table-bordered pc-table editor-content">
                        	<tr>
                                <td><textarea name="es-formCode" rows="10"><?php echo $es->formCode; ?></textarea></td>
                            </tr>
                        </table>
...
<input type="hidden" name="template" value="support" />
<input type="hidden" name="es-template" value="support" />
