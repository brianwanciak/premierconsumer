<?php 
	$templateString = ($template != "") ? $template : "page";
?>
<div class="row-fluid">
    <span class="span12">
...
<input type="hidden" name="template" value="<?php echo $templateString; ?>" />
<input type="hidden" name="es-template" value="<?php echo $templateString; ?>" />
